...
The following commands can be used to perform the initial checkout of Pagination:
...
Install Pagination's dependencies using [Composer](https://getcomposer.org/):
