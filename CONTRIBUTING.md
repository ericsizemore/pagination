...
These contributions can be made in the form of Issues or [Pull Requests](http://help.github.com/send-pull-requests/) on the [library's repository](https://github.com/ericsizemore/pagination).

Here are some examples how you can contribute:

* [Report a bug](https://github.com/ericsizemore/pagination/issues/new?labels=bug,unverified&template=1-bug_report.yml)
* [Propose a new feature](https://github.com/ericsizemore/pagination/issues/new?labels=enhancement,unverified&template=2-feature_request.yml)
* [Send a pull request](https://github.com/ericsizemore/pagination/pulls)
...
- Create your branch from `master` if you plan to implement new functionality or change existing code significantly.
  ...
  - Pull requests for bug fixes must be made for the oldest branch that is [supported](https://github.com/ericsizemore/pagination/blob/master/SECURITY.md).
...
[Backwards compatibility](https://github.com/ericsizemore/pagination/blob/master/backward-compatibility.md) breaks in this project are being kept to an absolute minimum. Please take this into account when proposing changes.
...
```bash
$ git clone https://github.com/ericsizemore/pagination.git
$ cd pagination
```
